...
export default function Loader() {
    return (
      <div className="fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-gradient-to-r from-[#211b5b]  to-[#302b63] z-50">
        <div className='flex justify-center items-center lg:w-[50%] 
          md:w-[40%] w-[60%]   rounded-full overflow-hidden '>
          {homePageImg&&<img src={homePageImg} alt="homePageLogo" className=' lg:w-[60%]  w-[100%] ' />}
        </div>
