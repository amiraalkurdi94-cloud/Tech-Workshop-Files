...
function TeamCard({ name, image, title, description, socialLinks }) {
    ...
    return (
        ...
        <div className="w-full  bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300
            ...
            <div className={`w-[200px] md:w-[220px] lg:w-[240px] 
                h-[200px] md:h-[220px] lg:h-[240px] mb-6 lg:mb-0 flex justify-center items-center
                ...
                <img
                    ...
                    alt={`${name}'s picture`}
                    className={`
                        'rounded-full ring-4 ring-blue-500 ring-opacity-50' 
                        w-full object-cover transition-all duration-300
                        hover:shadow-lg`}
                />
                :<div className="w-[80%] p-2.5 h-[80%] rounded-full bg-gray-400 flex justify-center items-center ">
                    <FaUser className="w-[80%] h-[80%]  "/>
                </div>
                }
            </div>
