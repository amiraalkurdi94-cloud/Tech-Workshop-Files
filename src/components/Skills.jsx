...
const Skills = () => {
    ...
    return (
        <div  className="skills">
            <h1 className="text-center text-4xl font-bold mb-14">Team Skills</h1>
                        ...
                        return (
                            ...
                            >
                                {skill.icon?
                                    ...
                                    :<div className="w-[50px] h-[50px] bg-gray-700" ></div>
                                }
                                <div className="flex flex-col justify-center items-start text-center">
                                    <h2 className="text-2xl font-semibold">{skill.name&&skill.name.replace(' ','')!==''?skill.name:"skill name"}</h2>
                                </div>
                            </div>
                        )
                    })
