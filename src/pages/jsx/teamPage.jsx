...
const TeamPage = () => {
    ...
    return (
        <section id="team" className="section-padding relative bg-gradient-to-r from-[#0f0c29]  to-[#302b63] text-white py-16 md:py-20">
            <div className="container mx-auto my-8 px-8 relative">
